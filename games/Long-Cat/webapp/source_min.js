...
function initPokiSdk(){if(!pokiDebug){return;}
...
gameReadyToStart=true;PokiSDK.gameLoadingFinished();console.log("Starting game");startGame();}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-5BFC1C2A246D67DD','948d3db9-a37d-4625-88aa-40c92f815ef7');}
...
function adInterstitialShow(){simpleLogC("adInterstitialShow()");setGameFocus(true);Module.ccall("ad_interstitial_on_showed","v",["number"],[1]);}
function adRewardedShow(){simpleLogC("adRewardedShow()");Module.ccall("ad_rewarded_on_showed","v",["number"],[1]);Module.ccall("ad_rewarded_on_rewarded","v");}
...
window.PokiSDK = {
    ...
    gameplayStart: () => { console.log("Poki gameplayStart - disabled"); },
    gameplayStop: () => { console.log("Poki gameplayStop - disabled"); },
    gameLoadingStart: () => { console.log("Poki gameLoadingStart - disabled"); },
    gameLoadingFinished: () => { console.log("Poki gameLoadingFinished - disabled"); },
    happyTime: () => { console.log("Poki happyTime - disabled"); },
    destroy: () => { console.log("Poki destroy - disabled"); }
};
...
function adRewardedShow() {
    console.log("Rewarded ad skipped - granting reward");
    Module.ccall("ad_rewarded_on_showed", "v", ["number"], [1]);
    Module.ccall("ad_rewarded_on_rewarded", "v");
}

function pokiSendLevelData() {
    console.log("Poki level data sending disabled");
}

function initPokiSdk() {
    console.log("Poki SDK initialization disabled");
    setPokiInited();
}
